...
/**
 * /evaluations, /evaluations/[evaluationId] 세그먼트 에러 경계.
 * lib/api/evaluations.ts는 API 실패를 목업으로 덮지 않고 그대로 던진다 — 여기서 잡아
 * 화면에 명확히 드러낸다(조용한 폴백 금지). MySQL 미기동 등으로 /api가 500을 반환하면
 * 여기가 뜬다.
 */
  ...
  return (
    <div className="px-6 py-16 flex flex-col items-center text-center gap-3">
      <p className="text-sm font-semibold text-danger-text">
        채점 데이터를 불러오지 못했습니다{status ? ` (HTTP ${status})` : ''}
      </p>
